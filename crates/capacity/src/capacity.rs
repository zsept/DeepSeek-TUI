...
impl CapacityControllerConfig {
    ...
    #[must_use]
    pub fn from_app_config(config: &deepseek_shared::config::Config) -> Self {
...
mod tests {
    ...
    fn app_config_without_capacity_uses_default_disabled() {
        let cfg = CapacityControllerConfig::from_app_config(&deepseek_shared::config::Config::default());
