...
use crate::core::compaction::estimate_tokens;
use crate::core::error_taxonomy::ErrorCategory;
use deepseek_models::{Message, SystemPrompt, context_window_for_model};
...
pub(super) fn is_context_length_error_message(message: &str) -> bool {
    crate::core::error_taxonomy::classify_error_message(message) == ErrorCategory::InvalidInput
}
