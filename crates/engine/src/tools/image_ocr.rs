...
//!
//! Registration is gated by [`deepseek_support::dependencies::resolve_tesseract`]
...
impl ToolSpec for ImageOcrTool {
    ...
    async fn execute(&self, input: Value, context: &ToolContext) -> Result<ToolResult, ToolError> {
        ...
        let tesseract = deepseek_support::dependencies::resolve_tesseract().ok_or_else(|| {
...
mod tests {
    ...
    fn tesseract_present() -> bool {
        deepseek_support::dependencies::resolve_tesseract().is_some()
    }
