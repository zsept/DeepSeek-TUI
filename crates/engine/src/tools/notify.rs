...
// ── Stubs (full impl in crates/tui) ──
pub enum Method { Auto, Bell, Osc9 }
fn notify_done(_method: Method, _in_tmux: bool, _msg: &str, _cooldown: std::time::Duration, _duration: std::time::Duration) {}
