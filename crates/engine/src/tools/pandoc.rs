...
//!
//! Registration is gated by [`deepseek_support::dependencies::resolve_pandoc`]
...
impl ToolSpec for PandocConvertTool {
    ...
    async fn execute(&self, input: Value, context: &ToolContext) -> Result<ToolResult, ToolError> {
        ...
        // Command::spawn.
        let pandoc = deepseek_support::dependencies::resolve_pandoc().ok_or_else(|| {
...
mod tests {
    ...
    fn pandoc_present() -> bool {
        deepseek_support::dependencies::resolve_pandoc().is_some()
    }
