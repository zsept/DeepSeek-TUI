...
use deepseek_base::command_safety::{SafetyLevel, analyze_command, extract_primary_command};
use deepseek_execpolicy::{ExecPolicyRuleDecision, load_default_policy};
use deepseek_config::features::Feature;
...
impl ToolSpec for ExecShellTool {
    ...
    async fn execute(
        ...
        let extra_env = if let Some(hook_executor) = &context.runtime.hook_executor {
            let hook_ctx = deepseek_support::hooks::HookContext::new()
