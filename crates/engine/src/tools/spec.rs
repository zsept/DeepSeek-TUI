...
use deepseek_config::features::Features;
use deepseek_lsp::LspManager;
use deepseek_base::network_policy::NetworkPolicyDecider;
...
pub struct RuntimeToolServices {
    ...
    pub hook_executor: Option<std::sync::Arc<deepseek_support::hooks::HookExecutor>>,
