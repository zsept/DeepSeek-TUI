...
use deepseek_base::network_policy::{Decision, host_from_url};
...
fn url_encode(input: &str) -> String {
    deepseek_support::utils::url_encode(input)
}
...
mod tests {
    ...
    fn network_policy_denies_direct_open_url() {
        use deepseek_base::network_policy::{Decision, NetworkPolicy, NetworkPolicyDecider};
