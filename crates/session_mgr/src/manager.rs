...
use deepseek_base::context_ref::ContextReference;
use deepseek_support::utils::write_atomic;
    ...
    fn test_session_context_references_round_trip() {
        ...
        session.context_references.push(SessionContextReference {
            ...
            reference: ContextReference {
                kind: deepseek_base::context_ref::ContextReferenceKind::File,
                source: deepseek_base::context_ref::ContextReferenceSource::AtMention,
