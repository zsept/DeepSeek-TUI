...
use crate::capacity::coherence::CoherenceState;
...
impl RuntimeThreadManager {
        ...
        engine
            .send(Op::SendMessage {
                ...
                approval_mode: if auto_approve {
                    ...
                    crate::mode_types::ApprovalMode::Suggest
                },
            })
            .await
    ...
    async fn ensure_engine_loaded(&self, thread: &ThreadRecord) -> Result<EngineHandle> {
        ...
        let engine_cfg = EngineConfig {
            ...
            capacity: crate::capacity::capacity::CapacityControllerConfig::from_app_config(
                &self.config,
            ),
