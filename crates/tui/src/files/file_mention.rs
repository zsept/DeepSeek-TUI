...
impl ContextReference {
    ...
    pub fn to_engine(&self) -> deepseek_shared::context_ref::ContextReference {
        deepseek_shared::context_ref::ContextReference {
            kind: match self.kind {
                ContextReferenceKind::File | ContextReferenceKind::Directory => {
                    deepseek_shared::context_ref::ContextReferenceKind::File
                }
                _ => deepseek_shared::context_ref::ContextReferenceKind::AtSymbol,
            },
            source: match self.source {
                ContextReferenceSource::AtMention => {
                    deepseek_shared::context_ref::ContextReferenceSource::AtMention
                }
...
pub fn find_file_mention_completions(
    ...
    tracing::debug!(
        target: "deepseek_shared::file_mention",
        partial = %partial,
