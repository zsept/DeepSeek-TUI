...
pub(crate) fn is_file_tree_toggle_shortcut(key: &KeyEvent) -> bool {
...
pub(crate) fn tool_details_shortcut_label() -> &'static str {
...
pub(crate) fn activity_shortcut_label() -> &'static str {
    "Ctrl+O"
}
...
pub(crate) fn alt_nav_modifiers(modifiers: KeyModifiers) -> bool {
    modifiers.contains(KeyModifiers::ALT)
        && !modifiers.contains(KeyModifiers::CONTROL)
        && !modifiers.contains(KeyModifiers::SUPER)
}

pub(crate) fn is_macos_option_v_legacy_key(key: &KeyEvent) -> bool {
    is_macos_option_v_legacy_key_for_platform(key, cfg!(target_os = "macos"))
}

pub(crate) fn is_macos_option_v_legacy_key_for_platform(key: &KeyEvent, is_macos: bool) -> bool {
...
pub(crate) fn is_paste_shortcut(key: &KeyEvent) -> bool {
...
pub(crate) fn is_ctrl_h_backspace(key: &KeyEvent) -> bool {
