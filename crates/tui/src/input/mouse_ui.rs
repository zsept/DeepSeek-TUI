...
use crate::input::context_menu::{ContextMenuEntry, ContextMenuView};
use crate::render::history::HistoryCell;
use crate::state::scrolling::{ScrollDirection, TranscriptScroll};
...
pub(crate) fn handle_context_menu_action(app: &mut App, action: ContextMenuAction) {
    match action {
        ...
        ContextMenuAction::OpenFileAtLine { cell_index } => {
            ...
            if crate::render::history::try_open_file_at_line(&text, &app.workspace) {
