...
pub(crate) fn cache_warmup_result(usage: &Usage) -> String {
    let cache = match (
...
pub(crate) fn prefix_stability_chip(app: &App) -> Option<(String, ratatui::style::Color)> {
...
pub(crate) fn available_models_message(current_model: &str, models: &[String]) -> String {
