...
use deepseek_tui::tools::review::ReviewOutput;
...
pub enum HistoryCell {
    ...
    Error {
        message: String,
        severity: deepseek_tui::core::error_taxonomy::ErrorSeverity,
    },
    Thinking {
        content: String,
        streaming: bool,
...
fn error_label_text(severity: deepseek_tui::core::error_taxonomy::ErrorSeverity) -> &'static str {
    match severity {
        deepseek_tui::core::error_taxonomy::ErrorSeverity::Critical
        | deepseek_tui::core::error_taxonomy::ErrorSeverity::Error => "Error",
        deepseek_tui::core::error_taxonomy::ErrorSeverity::Warning => "Warn",
        deepseek_tui::core::error_taxonomy::ErrorSeverity::Info => "Info",
    }
}

/// Label color for an error cell — drives the leading rail glyph.
fn error_label_style(severity: deepseek_tui::core::error_taxonomy::ErrorSeverity) -> Style {
    let color = match severity {
        deepseek_tui::core::error_taxonomy::ErrorSeverity::Critical
        | deepseek_tui::core::error_taxonomy::ErrorSeverity::Error => palette::STATUS_ERROR,
        deepseek_tui::core::error_taxonomy::ErrorSeverity::Warning => palette::STATUS_WARNING,
        deepseek_tui::core::error_taxonomy::ErrorSeverity::Info => palette::TEXT_DIM,
    };
...
fn error_body_style(severity: deepseek_tui::core::error_taxonomy::ErrorSeverity) -> Style {
    let color = match severity {
        deepseek_tui::core::error_taxonomy::ErrorSeverity::Critical
        | deepseek_tui::core::error_taxonomy::ErrorSeverity::Error => palette::STATUS_ERROR,
        deepseek_tui::core::error_taxonomy::ErrorSeverity::Warning => palette::STATUS_WARNING,
        deepseek_tui::core::error_taxonomy::ErrorSeverity::Info => palette::TEXT_MUTED,
    };
    Style::default().fg(color)
}
...
mod tests {
    ...
    fn plan_update_cell_renders_with_dark_theme_tokens() {
        let theme = Theme::for_mode(deepseek_tui::palette::PaletteMode::Dark);
    ...
    fn error_severity_cell_renders_in_red() {
        let cell = HistoryCell::Error {
            ...
            severity: deepseek_tui::core::error_taxonomy::ErrorSeverity::Error,
        };
        let lines = cell.lines(80);
        assert!(
            !lines.is_empty(),
    ...
    fn warning_severity_cell_renders_in_amber() {
        let cell = HistoryCell::Error {
            ...
            severity: deepseek_tui::core::error_taxonomy::ErrorSeverity::Warning,
        };
        let lines = cell.lines(80);
    ...
    fn critical_severity_cell_renders_in_red() {
        let cell = HistoryCell::Error {
            ...
            severity: deepseek_tui::core::error_taxonomy::ErrorSeverity::Critical,
        };
        let lines = cell.lines(80);
        let label_span = &lines[0].spans[0];
        assert_eq!(label_span.content.as_ref(), "Error");
    ...
    fn info_severity_cell_renders_in_dim() {
        let cell = HistoryCell::Error {
            ...
            severity: deepseek_tui::core::error_taxonomy::ErrorSeverity::Info,
        };
        let lines = cell.lines(80);
        let label_span = &lines[0].spans[0];
