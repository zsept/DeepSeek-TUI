...
use crate::ui::clipboard::{ClipboardContent, ClipboardHandler};
use crate::ui::file_mention::ContextReference;
use crate::ui::history::{HistoryCell, TranscriptRenderOptions};
use crate::ui::paste_burst::{FlushResult, PasteBurst};
use crate::ui::scrolling::{MouseScrollState, TranscriptLineMeta, TranscriptScroll};
use crate::ui::selection::{SelectionAutoscroll, TranscriptSelection};
use crate::ui::streaming::StreamingState;
use crate::ui::transcript::TranscriptViewCache;
...
pub struct App {
    ...
    pub file_tree: Option<crate::ui::file_tree::FileTreeState>,
    #[allow(dead_code)]
    ...
    pub backtrack: crate::ui::backtrack::BacktrackState,
...
impl App {
    ...
    pub fn new(options: TuiOptions, config: &Config) -> Self {
        ...
        let was_onboarded = crate::ui::onboarding::is_onboarded();
        ...
        let needs_workspace_trust =
            initial_mode != AppMode::Yolo && crate::ui::onboarding::needs_trust(&workspace);
        ...
        Self {
            ...
            backtrack: crate::ui::backtrack::BacktrackState::new(),
    ...
    pub fn finish_onboarding(&mut self) {
        ...
        if let Err(err) = crate::ui::onboarding::mark_onboarded() {
    ...
    pub fn composer_attachment_count(&self) -> usize {
        crate::ui::file_mention::media_attachment_references(&self.input).len()
    }
    ...
    pub fn remove_selected_composer_attachment(&mut self) -> bool {
        let references = crate::ui::file_mention::media_attachment_references(&self.input);
        let Some(index) = self
            .selected_composer_attachment_index()
...
mod tests {
    ...
    use crate::ui::clipboard::PastedImage;
    ...
    fn composer_paste_flushes_pending_burst_and_normalizes_crlf() {
        ...
        assert!(crate::ui::paste::handle_paste_burst_key(
            &mut app, &key, now
        ));
        assert!(
            app.input.is_empty(),
