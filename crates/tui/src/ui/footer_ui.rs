...
use crate::ui::ui_text::{concise_shell_command_label, truncate_line_to_width};
...
pub(crate) fn footer_mode_style(app: &App) -> (&'static str, ratatui::style::Color) {
    ...
    let color = match app.mode {
        crate::ui::app::AppMode::Limited => app.theme.mode_agent,
        crate::ui::app::AppMode::Yolo => app.theme.mode_yolo,
        crate::ui::app::AppMode::Plan => app.theme.mode_plan,
    };
    (label, color)
}
