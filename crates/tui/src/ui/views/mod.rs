...
use crate::tools::agent::{AgentAssignment, AgentResult, AgentStatus, AgentRole};
use crate::ui::app::App;
use crate::ui::approval::{ElevationOption, ReviewDecision};
...
pub enum ViewEvent {
    ...
    ModelPickerApplied {
        model: String,
        effort: crate::ui::app::ReasoningEffort,
    ...
    BacktrackStep {
        direction: crate::ui::backtrack::Direction,
    },
...
mod tests {
    ...
    use crate::ui::history::{HistoryCell, AgentCell};
