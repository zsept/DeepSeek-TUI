...
use crate::palette;
use crate::tools::agent::MailboxMessage;
...
mod tests {
    ...
    fn fanout_started_claims_seeded_pending_slot_without_growing_grid() {
        ...
        let started =
            MailboxMessage::started("agent_live", crate::tools::agent::AgentRole::General);
    ...
    fn fanout_apply_transitions_worker_through_lifecycle() {
        ...
        let started = MailboxMessage::started("w_1", crate::tools::agent::AgentRole::General);
