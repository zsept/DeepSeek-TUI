...
/// reuses [`crate::ui::notifications::humanize_duration`] for
...
pub fn footer_worked_chip(elapsed: std::time::Duration) -> Vec<Span<'static>> {
    ...
    let label = format!(
        "worked {}",
        crate::ui::notifications::humanize_duration(elapsed)
    );
    vec![Span::styled(
        label,
...
mod tests {
    ...
    use crate::palette;
    use crate::ui::app::{App, AppMode, TuiOptions};
    use ratatui::{
        style::{Color, Style},
        text::Span,
    };
    ...
    fn make_app() -> App {
        ...
        app.theme = crate::ui::theme::DARK_THEME;
        app
    }
