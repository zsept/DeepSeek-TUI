...
use deepseek_tui::tools::UserInputResponse;
use deepseek_tui::tools::agent::{AgentAssignment, AgentResult, AgentStatus, AgentRole};
use crate::app::App;
...
pub enum ViewEvent {
    ...
    ProviderPickerApplied {
        provider: deepseek_tui::config::ApiProvider,
    },
    ...
    StatusItemsUpdated {
        items: Vec<deepseek_tui::config::StatusItem>,
        final_save: bool,
    },
